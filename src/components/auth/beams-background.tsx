...
function extendMaterial<T extends THREE.Material>(
  ...
  if (typeof defaults.roughness === "number")
    uniforms.roughness.value = defaults.roughness;
  if (typeof defaults.metalness === "number")
    uniforms.metalness.value = defaults.metalness;
  if (defaults.envMap) uniforms.envMap.value = defaults.envMap;
  if (typeof defaults.envMapIntensity === "number")
